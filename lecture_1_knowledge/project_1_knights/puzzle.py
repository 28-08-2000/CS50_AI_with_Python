...
#knowledge Base of the puzzle
#true and false are implemented within the puzzles itself

# Puzzle 0
# A says "I am both a knight and a knave."
#taking two cases of each say as a knight and as a knave
knowledge0 = And(
